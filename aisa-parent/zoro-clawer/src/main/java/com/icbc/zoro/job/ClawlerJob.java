...
import com.icbc.zoro.clawer.ClawerTask;
import com.icbc.zoro.clawer.mapper.ClawerMapper;
import com.icbc.zoro.common.ApplicationContextProvider;
...
import com.icbc.zoro.webmagic.scheduler.DepthScheduler;

import us.codecraft.webmagic.Spider;
import us.codecraft.webmagic.pipeline.JsonFilePipeline;
@SuppressWarnings("unused")
@Component
public class ClawlerJob {
	private static Logger logger = LogManager.getLogger(ClawlerJob.class.getName());
	@Autowired
